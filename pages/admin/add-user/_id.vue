        ...
        <div class="custom-card plan">
          ...
          <div class="input-wrapper w-form">
            ...
            <form class="input-form" @submit.prevent="">
              <div class="each-input">
                <label for="name-4" class="input-label">Select Currency</label>
                <h4 class="select-display">
                  {{ currency }}
                </h4>
                <ul
                  role="list"
                  class="filter-list down"
                  :class="{ hide: !showCurrencyList }"
                >
                  <li
                    class="filter-items"
                    ...
                    :key="i"
                  >
                    <div @click="selectCurrency(item.name)">
                      {{ item.name }}
                    </div>
                  </li>
                </ul>
              ...
              <div v-if="account" class="each-input">
                <label for="name-4" class="input-label">Currency</label>
                <h4 class="select-display">
                  {{ account.currency }}
                </h4>
              </div>
