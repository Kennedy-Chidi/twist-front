              ...
              <div class="form-register-holder">
                ...
                <div class="form-section-holder">
                    ...
                    <div class="register-content-holder">
                      ...
                      <div class="register-form-holder">
                        ...
                        <div class="dropdown-container">
                          <h3
                            class="drop-tittle"
                            @click="
                              showCurrencyTypeList = !showCurrencyTypeList
                            "
                          >
                            {{ currency }}
                          </h3>
                          ...
                          <ul
                            role="list"
                            class="drop-down-list"
                            v-if="showCurrencyTypeList"
                          >
                            <li
                              v-for="(account, int) in currencies"
                              :key="int"
                              class="drop-down-each-list"
                              @click="selectCurrrencyType(account.name)"
                            >
                              <div class="dropdown-each-list-item">
                                {{ account.name }}
                              </div>
                      ...
                      <div class="register-form-holder">
                        ...
                        <div class="register-mark-box-container">
                          <div class="register-mark-box-holder">
                            <div class="register-input-text-holder">
                              <div class="register-mark-box-texts">Single</div>
                            </div>
                            <div
                    ...
                    <div class="register-content-holder">
                      <div class="register-form-holder">
                        ...
                        <input
                          ...
                          @keyup="
                            setFormSection('residentAddress1', residentAddress1)
                          "
                        />
                      </div>
                      <div class="register-form-holder">
                        <div class="register-input-text-holder">
                          <div class="register-input-texts">Address 2</div>
                        </div>
                        <input
                          type="text"
                          class="registration-input w-input"
                      ...
                      <div class="register-form-holder">
                        <div class="register-input-text-holder">
                          <div class="register-input-texts">Land mark</div>
                        </div>
                        <input
                          type="text"
                          class="registration-input w-input"
                          maxlength="256"
                          placeholder="Enter Land Mark/District"
                          required=""
                  ...
                  <div v-else-if="formPage == 2" class="each-register-holder">
                    <div class="register-top-heading-holder">
                      <h1 class="register-top-heading">Nationality</h1>
                    </div>
                    <div class="register-content-holder">
                      <div class="register-form-holder">
                        <div class="register-input-text-holder">
                        ...
                        <input
                          ...
                          @keyup="
                            setFormSection('originAddress1', originAddress1)
                          "
                        />
                      </div>
                      <div class="register-form-holder">
                      ...
                      <div class="register-form-holder">
                        ...
                        <input
                          ...
                          class="registration-input w-input"
                          maxlength="256"
                          placeholder="Land mark/District"
                          required=""
                      ...
                      <div class="register-form-holder">
                        <div class="register-input-text-holder">
                          <div class="register-input-texts">Zip code</div>
                        </div>
                        <input
                          type="text"
                          class="registration-input w-input"
                      ...
                      <div class="register-form-holder">
                        ...
                        <input
                          ...
                          required=""
                          v-model="originState"
                          @keyup="setFormSection('originState', originState)"
                        />
                      </div>
                      <div class="register-form-holder">
                        <div class="register-input-text-holder">
                        ...
                        <div class="dropdown-container">
                          <h3
                            class="drop-tittle"
                            @click="
                              showOriginCountryList = !showOriginCountryList
                            "
                          >
                            {{ originCountry }}
                          </h3>
                          ...
                          <ul
                            role="list"
                            class="drop-down-list"
                            v-if="showOriginCountryList"
                          >
                            <li
                              v-for="(country, int) in countryArray"
                              :key="int"
                              class="drop-down-each-list"
                              @click="selectOriginCountry(country)"
                            >
                              <div class="dropdown-each-list-item">
                                {{ country }}
                              </div>
                  ...
                  <div v-else-if="formPage == 3" class="each-register-holder">
                    <div class="register-top-heading-holder">
                    ...
                    <div class="register-content-holder">
                      ...
                      <div class="register-form-holder">
                        ...
                        <input
                          ...
                          required=""
                          @keyup="setFormSection('phoneNumber1', phoneNumber1)"
                        />
                      </div>
                      <div class="register-form-holder">
                        <div class="register-input-text-holder">
                          <div class="register-input-texts">Phone Number 2</div>
                        </div>
                        <input
                          type="text"
                          class="registration-input w-input"
...
// import { formSectionArray } from "../functions/signupFunctions";
export default {
  data() {
    return {
      firstName: "",
  ...
  methods: {
    ...
    clearInputs() {
      ...
      this.gender = "";
      this.maritalStatus = "";
      (this.currencyType = "Select Currency"), (showIncomeList = false);
      this.showCountryList = false;
      this.showOriginCountryList = false;
      this.showIdList = false;
      this.showCurrencyTypeList = false;

      this.residentAddress1 = "";
      this.residentAddress2 = "";
      ...
      this.originState = "";
      this.originZipCode = "";
      this.originCountry = "Select Country";
    ...
    processUserData() {
      ...
      if (this.password != this.cPassword) {
        ...
        form.append("kinFullName", this.kinFullName);
    ...
    async createCurrency() {
      const form = new FormData();
      form.append("name", "USD");
      form.append("dateCreated", new Date().getTime());
      try {
        const result = await this.$axios.post("/currency", form);
        this.currencies = result.data.data;
      } catch (err) {
...
.register-rate-complete.check-3 {
  width: 100%;
}

.register-rate-complete.check-4 {
  width: 100%;
}
